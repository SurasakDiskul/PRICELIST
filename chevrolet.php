    ...
    <div class="row">
      <div class="col-lg-12 text-center">
          <ul class="list-inline mb-0">
           ...
           <h1 class="text-lg text-white mt-2">CHEVROLET</h1>
      </div>
    </div>
  </div>
</section>
...
<section class="section course bg-gray">
	<div class="container">
      ...
      <a href="./brands/chevrolettruck.php">
               ...
               รถอเนกประสงค์ / <br>
               รถตู้</h4></h4>
						<p class="text-secondary mb-2">CHEVROLET</p>
					</div>
				</div>
        </a>
			</div>
			...
			<div class="col-lg-3 col-md-6">
      <a href="./brands/chevroletautomobile.php">
				<div class="card border-0 rounded-0 p-0 mb-5 mb-lg-0 shadow-sm">
					<img src="./logo.png" alt="" class="img-fluid">
					<div class="card-body">
