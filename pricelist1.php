...
<section class="section services" id="pricelist">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-8 text-center">
				<div class="section-title">
					...
					<p>You can choose to view car suspension parts by type of suspension as below.</p>
					<div class="row justify-content-center">
					<a href="./index.php#pricelist" class="btn btn-outline-secondary">ยี่ห้อรถยนต์</a>
					&nbsp;<a href="./index1.php#pricelist" class="btn btn-secondary">ประเภทสินค้า</a>
		...
		<div class="row no-gutters justify-content-center">
            ...
            <a href="./suspension/suspension.php?id=<?php echo $row['id'] ?>">
