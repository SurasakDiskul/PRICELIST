                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="./truck.php">Truck And Other</a></li>
                                </ul>
                            </li>
                            <li>
          ...
          <div class="col-md-12">
            <div class="card card-tasks">
              <div class="card-header ">
                <h4 class="card-title">Truck And Other - เพิ่มจำนวนหน้าในสมุดราคาแยกตามยี่ห้อรถบรรทุกและรถอื่นๆ
              </div>
              <div class="card-body ">
              <div id="filter">
                        <span>เลือกยี่ห้อรถบรรทุกที่ต้องการ</span>
                        <div class="row">
                          <div class="col-5">
                        <select class="form-select" name="fetchval" id="fetchval" >
                            ...
                            <option value="TOYOTA TRUCK">TOYOTA TRUCK</option>
                            <option value="OTHER TRUCK">OTHER TRUCK</option>
                            <option value="KUBOTA">KUBOTA</option>
                            <option value="GOLF CAR, ATV/FORKLIFT">GOLF CAR, ATV/FORKLIFT</option>
                        </select>
