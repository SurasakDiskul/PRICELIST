    ...
    <div class="row">
      <div class="col-lg-12 text-center">
          <ul class="list-inline mb-0">
           ...
           <h1 class="text-lg text-white mt-2">OWN BRAND & DISTRIBUTOR AGENT</h1>
      </div>
    </div>
  </div>
</section>
...
<section class="section course bg-gray">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-8 text-center">
				<div class="section-title">
					...
					<h2>OWN BRAND & DISTRIBUTOR AGENT</h2>
					<p></p>
				</div>
			</div>
		</div>
		...
		<div class="row justify-content-center">
					<img src="./images/สมุดราคา 333version9.2_Page_008.jpg" alt="" class="img-fluid">
          <img src="./images/สมุดราคา 333version9.2_Page_009.jpg" alt="" class="img-fluid">
			</div>
